  ...
  return (
    <div className="bg-slate-950 text-slate-100 font-sans">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-4">
        <div className="z-10 bg-slate-950/50 p-8 rounded-xl border border-slate-800">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            A regulatory-grade pipeline data platform engineered for high-integrity midstream
            reporting.
          </p>
          <div className="mt-8 flex gap-4 justify-center">
            <a
              href="#sprints"
              className="bg-orange-600 hover:bg-orange-700 px-6 py-3 rounded-lg font-bold transition"
            >
              View Build Plan
            </a>
      ...
      <section className="relative min-h-screen py-24 px-8 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold mb-12 border-l-4 border-orange-500 pl-4">
          The Requirement-to-Proof Mapping
        </h2>
        <div className="grid md:grid-cols-2 gap-6">
          {[
            {
              req: "Build & maintain data pipelines",
              proof: "Bronze → Silver → Gold, orchestrated end to end",
            },
            ...
            <div key={i} className="bg-slate-900/60 p-6 rounded-lg border border-slate-800">
              <p className="text-orange-400 text-sm font-mono mb-2 uppercase tracking-tighter italic">
      ...
      <div ref={containerRef} className="relative">
        ...
        <section className="h-[150vh] relative px-8">
          <div className="sticky top-1/4 max-w-lg bg-slate-950/80 p-8 rounded-2xl border border-slate-700 shadow-2xl">
            <span className="text-orange-500 font-mono font-bold uppercase tracking-widest">
              Sprint 01
            </span>
            <h2 className="text-4xl font-bold mt-2 mb-4 italic underline decoration-orange-500">
              The Skeleton
            </h2>
            <p className="text-slate-300 mb-6">
              Building the end-to-end spine using Databricks Free Edition and dbt-databricks.
            </p>
            <ul className="space-y-3">
              <li className="flex gap-3 text-sm items-center">
                <Database size={16} className="text-orange-400" /> Ingesting telemetry & reference
                data
              </li>
              <li className="flex gap-3 text-sm items-center">
                <Workflow size={16} className="text-orange-400" /> First Gold-layer throughput mart
              </li>
              <li className="flex gap-3 text-sm items-center">
                <BarChart3 size={16} className="text-orange-400" /> Power BI connection established
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="h-[150vh] relative px-8 flex justify-end">
          <div className="sticky top-1/4 max-w-lg bg-slate-950/80 p-8 rounded-2xl border border-slate-700 shadow-2xl text-right">
            <span className="text-orange-500 font-mono font-bold uppercase tracking-widest">
              Sprint 02
            </span>
            <h2 className="text-4xl font-bold mt-2 mb-4 italic underline decoration-orange-500">
            ...
            <p className="text-slate-300 mb-6">
              Turning scripts into a production pipeline with automated "circuit breakers".
            </p>
            <ul className="space-y-3">
              <li className="flex gap-3 text-sm items-center justify-end">
                Great Expectations data validation{" "}
                <ShieldCheck size={16} className="text-orange-400" />
              </li>
              <li className="flex gap-3 text-sm items-center justify-end">
                Automated quarantine for bad rows{" "}
                <ShieldCheck size={16} className="text-orange-400" />
              </li>
              <li className="flex gap-3 text-sm items-center justify-end">
                Failure alerts & freshness checks{" "}
                <ShieldCheck size={16} className="text-orange-400" />
              </li>
            </ul>
          </div>
        ...
        <section className="h-[150vh] relative px-8">
          <div className="sticky top-1/4 max-w-lg bg-slate-950/80 p-8 rounded-2xl border border-slate-700 shadow-2xl">
            ...
            <p className="text-slate-300 mb-6">
              Tailoring data for Operations, Finance, and Regulatory auditors.
            </p>
            <ul className="space-y-3">
              <li className="flex gap-3 text-sm items-center font-bold text-emerald-400">
                <CheckCircle2 size={16} /> Pressure-drop anomaly detection
              </li>
              <li className="flex gap-3 text-sm items-center font-bold text-emerald-400">
                <CheckCircle2 size={16} /> Unity Catalog data lineage
              </li>
              <li className="flex gap-3 text-sm items-center font-bold text-emerald-400">
                <CheckCircle2 size={16} /> Confidential column tagging
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="h-[150vh] relative px-8 flex justify-end">
          <div className="sticky top-1/4 max-w-lg bg-slate-950/80 p-8 rounded-2xl border border-slate-700 shadow-2xl text-right">
            ...
            <p className="text-slate-300 mb-6">
              Proving portability and documenting for the engineering team.
            </p>
